...
const SignupPage = () => {
  ...
  const [entityType, setEntityType] = useState('Holding');
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            >
              ...
              <option value="Buyer Entity">Buyer Entity</option>
          ...
          {userType != 'Individual' && (
            <>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Choose Entity Type*</label>
                <select
                  name="entityType"
                  value={entityType}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">{entityType === 'Holding' ? 'Holding Name' : 'Company Name'}*</label>
                <input
                  type="text"
                  name="companyName"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Trademark / Brand Name</label>
                <input
                  type="text"
                  name="brandName"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Commercial Registration Number*</label>
                <input
                  type="text"
                  name="taxId"
          ...
          {userType != 'Individual' && (
            <div className="flex items-center p-4 mb-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 border border-yellow-200" role="alert">
              <svg className="w-5 h-5 mr-2 text-yellow-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4a2 2 0 00-3.464 0L4.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">{ userType != 'Individual' ? 'Official Email Address' : 'Email Address' }*</label>
            <input
              type="email"
              name="email"
              value={formData.email}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">{ userType != 'Individual' ? 'Official Mobile' : 'Mobile' }*</label>
            <input
              type="tel"
              name="mobile"
