...
import { Plus, Search, Calendar, MapPin, Users, Package, AlertCircle, TrendingUp, Clock, CheckCircle2, MoreVertical, Eye, Edit2, Trash2, Archive } from 'lucide-react';
        ...
        <div className="px-6 py-6 ">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Manage and track all construction projects</p>
            </div>
            <button
          ...
          {filteredProjects.map((project) => (
            <div key={project.id} className="bg-white rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <div className="p-5 border-b border-gray-100">
                ...
                <span className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${getStatusBadge(project.status)}`}>
              ...
              <div className="p-5 space-y-4">
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs font-medium text-gray-900">{formatCurrency(project.budget)}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-gray-600">Spent</span>
                    <span className="text-xs font-medium text-gray-900">{formatCurrency(project.spent)}</span>
                  </div>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                  ...
                  {project.pendingRequests > 0 && (
                    <div className="flex items-center gap-1 text-yellow-600 bg-yellow-50 px-2 py-1 rounded-full">
                      ...
                      <span className="text-xs font-medium">{project.pendingRequests} pending</span>
                    </div>
                  )}
                </div>
              </div>
