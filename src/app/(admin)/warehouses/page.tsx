  ...
  const [companies, setCompanies] = useState([
    {
      ...
      code: "WH-001",
      description: "Primary storage facility for construction materials",
      status: "active",
    ...
    {
      id: 2,
      name: "Steel Storage Warehouse",
      code: "WH-002",
      description: "Specialized warehouse for steel and metal materials",
      status: "active",
    ...
    },
    {
      ...
      code: "WH-003",
      description: "Storage for machinery and construction equipment",
      status: "inactive",
    ...
    {
      id: 4,
      name: "Electrical Materials Warehouse",
      code: "WH-004",
      description: "Storage for cables, switches, and electrical supplies",
      status: "active",
    ...
    {
      id: 5,
      name: "Finishing Materials Store",
      code: "WH-005",
      description: "Warehouse for tiles, paints, and finishing materials",
      status: "active",
    ...
    {
      id: 6,
      name: "North Site Warehouse",
      code: "WH-006",
      description: "On-site storage facility for northern projects",
      status: "inactive",
    ...
    {
      id: 7,
      name: "Plumbing Materials Storage",
      code: "WH-007",
      description: "Storage for pipes, fixtures, and plumbing materials",
      status: "active",
    ...
    {
      id: 8,
      name: "Temporary Site Storage",
      code: "WH-008",
      description: "Temporary storage facility for ongoing projects",
      status: "active",
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Manage and track all warehouses
              </p>
            </div>
            <button
        ...
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-full sm:w-[480px] bg-white shadow-2xl z-[100000] flex flex-col animate-slide-in">
            ...
            <div className="p-6 pt-16 border-b border-gray-200">
              <h2 className="text-xl font-bold text-gray-900">New Warehouse</h2>
              <p className="text-sm text-gray-600 mt-1">
