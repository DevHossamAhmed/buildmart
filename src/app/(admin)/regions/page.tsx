  ...
  const [companies, setCompanies] = useState([
    {
      ...
      name: "Cairo Region",
      code: "REG-001",
      description: "Greater Cairo area including Giza and Qalyubia",
      status: "active",
    ...
    },
    {
      ...
      code: "REG-002",
      description: "Alexandria and northern coastal areas",
      status: "active",
    ...
    },
    {
      ...
      name: "Delta Region",
      code: "REG-003",
      description: "Nile Delta governorates and surrounding areas",
      status: "inactive",
    ...
    },
    {
      ...
      code: "REG-004",
      description: "Southern governorates including Luxor and Aswan",
      status: "active",
    ...
    },
    {
      ...
      name: "Red Sea Region",
      code: "REG-005",
      description: "Red Sea coastal cities and resorts",
      status: "active",
    ...
    },
    {
      ...
      name: "Sinai Region",
      code: "REG-006",
      description: "North and South Sinai governorates",
      status: "inactive",
    ...
    },
    {
      ...
      code: "REG-007",
      description: "Suez Canal cities including Port Said and Ismailia",
      status: "active",
    ...
    },
    {
      ...
      code: "REG-008",
      description: "Western desert governorates and oases",
      status: "active",
        ...
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-full sm:w-[480px] bg-white shadow-2xl z-[100000] flex flex-col animate-slide-in">
            ...
            <div className="p-6 pt-16 border-b border-gray-200">
              <h2 className="text-xl font-bold text-gray-900">New Region</h2>
              <p className="text-sm text-gray-600 mt-1">
